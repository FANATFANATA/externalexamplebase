...
namespace android
{
    namespace detail
    {
        ...
        struct StrongPointer
        {
            ...
            any_t *operator->() const { return pointer; }
            any_t *get() const { return pointer; }
        ...
        struct Functionals
        {
            ...
            void *(*SurfaceComposerClient__Transaction__SetTrustedOverlay)(void *thiz, StrongPointer<void> &surfaceControl,
            ...
            Functionals(const SymbolMethod &symbolMethod)
            {
                ...
                static std::unordered_map<size_t, std::unordered_map<void **, const char *>> patchesTable = {
                    ...
                    {15, {{reinterpret_cast<void **>(&LayerMetadata__Constructor), "_ZN7android3gui13LayerMetadataC2Ev"}, {reinterpret_cast<void **>(&SurfaceComposerClient__CreateSurface), "_ZN7android21SurfaceComposerClient13createSurfaceERKNS_7String8EjjiiRKNS_2spINS_7IBinderEEENS_3gui13LayerMetadataEPj"}, {reinterpret_cast<void **>(&LayerMetadata__setInt32), "_ZN7android3gui13LayerMetadata8setInt32Eji"}}},
                    {14, {{reinterpret_cast<void **>(&LayerMetadata__Constructor), "_ZN7android3gui13LayerMetadataC2Ev"}, {reinterpret_cast<void **>(&SurfaceComposerClient__CreateSurface), "_ZN7android21SurfaceComposerClient13createSurfaceERKNS_7String8EjjiiRKNS_2spINS_7IBinderEEENS_3gui13LayerMetadataEPj"}}},
                    {12, {{reinterpret_cast<void **>(&SurfaceComposerClient__Transaction__Apply), "_ZN7android21SurfaceComposerClient11Transaction5applyEb"}}},
                    {11, {{reinterpret_cast<void **>(&SurfaceComposerClient__CreateSurface), "_ZN7android21SurfaceComposerClient13createSurfaceERKNS_7String8EjjijPNS_14SurfaceControlENS_13LayerMetadataEPj"}, {reinterpret_cast<void **>(&SurfaceControl__GetSurface), "_ZNK7android14SurfaceControl10getSurfaceEv"}}},
                    {10, {{reinterpret_cast<void **>(&SurfaceComposerClient__CreateSurface), "_ZN7android21SurfaceComposerClient13createSurfaceERKNS_7String8EjjijPNS_14SurfaceControlENS_13LayerMetadataE"}, {reinterpret_cast<void **>(&SurfaceControl__GetSurface), "_ZNK7android14SurfaceControl10getSurfaceEv"}}},
                    {9, {{reinterpret_cast<void **>(&SurfaceComposerClient__CreateSurface), "_ZN7android21SurfaceComposerClient13createSurfaceERKNS_7String8EjjijPNS_14SurfaceControlEii"}, {reinterpret_cast<void **>(&SurfaceComposerClient__GetBuiltInDisplay), "_ZN7android21SurfaceComposerClient17getBuiltInDisplayEi"}, {reinterpret_cast<void **>(&SurfaceControl__GetSurface), "_ZNK7android14SurfaceControl10getSurfaceEv"}}},
                    {8, {{reinterpret_cast<void **>(&SurfaceComposerClient__CreateSurface), "_ZN7android21SurfaceComposerClient13createSurfaceERKNS_7String8EjjijPNS_14SurfaceControlEjj"}, {reinterpret_cast<void **>(&SurfaceComposerClient__GetBuiltInDisplay), "_ZN7android21SurfaceComposerClient17getBuiltInDisplayEi"}, {reinterpret_cast<void **>(&SurfaceControl__GetSurface), "_ZNK7android14SurfaceControl10getSurfaceEv"}}}};
#ifdef __LP64__
            ...
            static const Functionals &GetInstance(const SymbolMethod &symbolMethod = {dlopen, dlsym, dlclose})
            {
        ...
        struct LayerMetadata
        {
            ...
            operator void *() { return (9 < Functionals::GetInstance().systemVersion) ? reinterpret_cast<void *>(data) : nullptr; }
        };
        struct Surface
        {
        };
        struct SurfaceControl
        {
            ...
            int32_t Validate() { return data ? Functionals::GetInstance().SurfaceControl__Validate(data) : 0; }
            Surface *GetSurface()
            {
                if (!data)
                    return nullptr;
        ...
        struct SurfaceComposerClient
        {
            ...
            SurfaceControl CreateSurface(const char *name, int32_t width, int32_t height, bool hide, bool secure)
            {
                ...
                {
                    int value = (!secure && hide) ? 441731 : -1;
    ...
    public:
        ...
        {
            static detail::SurfaceComposerClient s;
            return s;
        }
        static DisplayInfo GetDisplayInfo()
        {
            auto &c = GetComposerInstance();
            detail::ui::DisplayState ds{};
            if (!c.GetDisplayInfo(&ds))
                return {};
            if (detail::Functionals::GetInstance().systemVersion <= 10)
            {
                DisplayInfo di{};
                if (static_cast<uint32_t>(ds.orientation) == 1 || static_cast<uint32_t>(ds.orientation) == 3)
                {
                    di.width = ds.layerStackSpaceRect.height;
                    di.height = ds.layerStackSpaceRect.width;
                }
                else
                {
                    di.width = ds.layerStackSpaceRect.width;
                    di.height = ds.layerStackSpaceRect.height;
                }
                di.orientation = static_cast<uint32_t>(ds.orientation);
                return di;
            }
            return {static_cast<uint32_t>(ds.orientation), ds.layerStackSpaceRect.width, ds.layerStackSpaceRect.height};
        }
        static ANativeWindow *Create(const char *name, int32_t width = -1, int32_t height = -1, bool hide = true, bool secure = false)
        {
            ...
            while (width == -1 || height == -1)
            {
                ...
                if (detail::Functionals::GetInstance().systemVersion <= 10)
                {
                    if (static_cast<uint32_t>(ds.orientation) == 1 || static_cast<uint32_t>(ds.orientation) == 3)
                    {
                        width = ds.layerStackSpaceRect.height;
                        height = ds.layerStackSpaceRect.width;
                    }
                    else
                    {
                        width = ds.layerStackSpaceRect.width;
                        height = ds.layerStackSpaceRect.height;
                    }
                }
                else
                {
            ...
            auto sc = c.CreateSurface(name, width, height, hide, secure);
            auto nw = reinterpret_cast<ANativeWindow *>(sc.GetSurface());
            m_cachedSurfaceControl.emplace(nw, sc);
            return nw;
        }
        static void Destroy(ANativeWindow *nw)
        {
            auto it = m_cachedSurfaceControl.find(nw);
            if (it == m_cachedSurfaceControl.end())
                return;
            m_cachedSurfaceControl[nw].DestroySurface(reinterpret_cast<detail::Surface *>(nw));
            m_cachedSurfaceControl.erase(nw);
        }
