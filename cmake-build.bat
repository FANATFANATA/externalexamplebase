...
"C:\Program Files\CMake\bin\cmake.EXE" -Wno-deprecated -G "MinGW Makefiles" -S "%JNI_DIR%" -B "%BUILD_DIR%\arm64-v8a" ^
...
"C:\Program Files\CMake\bin\cmake.EXE" -Wno-deprecated -G "MinGW Makefiles" -S "%JNI_DIR%" -B "%BUILD_DIR%\x86_64" ^
    -DCMAKE_MAKE_PROGRAM="%NDK_PATH%\prebuilt\windows-x86_64\bin\make.exe" ^
    -DCMAKE_TOOLCHAIN_FILE="%NDK_PATH%\build\cmake\android.toolchain.cmake" ^
    -DANDROID_ABI=x86_64 ^
    -DANDROID_PLATFORM=android-21 ^
